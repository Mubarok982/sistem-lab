                        ...
                        <form action="<?= base_url('mahasiswa/pengajuan'); ?>" method="post">
                            <div class="form-group">
                                ...
                                <select name="tema" id="tema" class="form-control" required>
                                    ...
                                    <option value="Networking" <?= set_select('tema', 'Networking'); ?>>Networking
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="skema" id="skema" class="form-control" required>
                                    ...
                                    <option value="Penyetaraan" <?= set_select('skema', 'Penyetaraan'); ?>>Penyetaraan
                                    </option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="naskah" id="naskah" class="form-control-file"
                                    accept=".pdf,.doc,.docx">
